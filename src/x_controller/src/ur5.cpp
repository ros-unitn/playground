...
static constexpr const char *PubTopics[] = {
    UR5_SHOULDER_PAN_TOPIC UR5_TARGET,
    UR5_SHOULDER_LIFT_TOPIC UR5_TARGET,
    UR5_ELBOW_TOPIC UR5_TARGET,
    UR5_WRIST_1_TOPIC UR5_TARGET,
    UR5_WRIST_2_TOPIC UR5_TARGET,
    UR5_WRIST_3_TOPIC UR5_TARGET,
};
static constexpr const char *SubTopics[] = {
    UR5_SHOULDER_PAN_TOPIC UR5_STATE,
    UR5_SHOULDER_LIFT_TOPIC UR5_STATE,
    UR5_ELBOW_TOPIC UR5_STATE,
    UR5_WRIST_1_TOPIC UR5_STATE,
    UR5_WRIST_2_TOPIC UR5_STATE,
    UR5_WRIST_3_TOPIC UR5_STATE,
};
